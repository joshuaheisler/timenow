...
class Absence(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='%(class)s_user', verbose_name='Benutzer')
    comment = models.CharField(max_length=300, blank=True, null=True, verbose_name='Kommentar')
    ...
    approved_by_comment = models.CharField(max_length=300, blank=True, null=True, verbose_name='Kommentar des Genehmigers')
